...
* (https://hackersstudy.tistory.com/72){:target="_blank"}

* (https://victorydntmd.tistory.com/154){:target="_blank"}
...
3. 웹브라우저에서 웹어플리케이션서버를 통해 JSP파일을 호출하였을 때 Servlet Container내에서의 처리과정
	...
	* 추가) WAS와 웹 서버의 차이
		* (https://jeong-pro.tistory.com/84){:target="_blank"}
