...
@Pointcut("execution(* com.javalec.ex..*.*()") // com.javalec.ex 패키디 & com.javalec.ex 하위 패키지에 파라미터가 없는 모든 메서드
...
* [스프링과정9강](http://seouliotcenter.tistory.com/74?category=663840){:target="_blank"} 블스(김명호 강사)
