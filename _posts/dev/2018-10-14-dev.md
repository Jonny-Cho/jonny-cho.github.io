...
* [ZeroCho Youtube](https://youtu.be/C8JUyp68N5k) 제로초님의 자바스크립트를 완강.
* 결과물로 [자바스크립트 로또생성기](https://github.com/Jonny-Cho/js_lotto)를 만들었다.
* 숫자가 1초에 하나씩 나오게 하기 위해서 setTimeout함수(비동기함수)를 반복문 안에서 사용하게 된다.
